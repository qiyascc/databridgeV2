...
class StoreSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Store
        fields = ('store_code', 'store_name', 'city_name', 'store_county', 'store_phone', 'address')
...
class ProductSizeDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ProductSize
        fields = ('id', 'size_name', 'size_id', 'size_general_stock', 'total_stock', 'store_stocks', 'city_availability')
...
class ProductDetailSerializer(serializers.ModelSerializer):
    ...
    def get_city_availability(self, obj):
        ...
        sizes = obj.sizes.prefetch_related('store_stocks', 'store_stocks__store', 'store_stocks__store__city')
        ...
        for city_id in city_data:
            ...
            city_data[city_id]['store_count'] = len(city_data[city_id]['store_count'])
